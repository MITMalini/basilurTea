    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/home/:id/addsupervisor"
            exact
            element={<AddSupervisor />}
          />
          <Route
            path="/home/:id/addtechnician"
            exact
          ...
          <Route
            path="/home/:id/addchangeover"
            exact
            element={<AddChangeOver />}
          />
          <Route path="/home/:id/generatepdf" exact element={<GeneratePDF />} />
          <Route path="/home/:id/:from_login" exact element={<Home />} />
          <Route
            path="/home/:id/viewallchangeovers"
            exact
